...
from flwr_torch_rnn.task import Net, get_weights
...
def avg_metrics(metrics: List[Tuple[int, Metrics]]) -> Metrics:
    ...
    for _,m in metrics:
        ...
        # get metric
        precision_temp = m.get("precision")
        recall_temp = m.get("recall")
        f1_score_temp = m.get("f1")
        # put metrics into array
    ...
    # return {"avg_precision": avg_precision, "avg_recall": avg_recall, "avg_f1_score": avg_f1_score}
