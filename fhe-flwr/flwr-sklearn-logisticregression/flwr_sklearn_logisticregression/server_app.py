...
from flwr_sklearn_logisticregression.Crypto.fhe_fed_avg import FheFedAvg
...
# mlflow.start_run(run_name = "Gobal_flwr-sklearn-logisticregression", log_system_metrics=True)
...
def server_fn(context: Context):
    ...
    # Define strategy
    strategy = FheFedAvg(
        # TODO: add these val to pyproject.toml
        fraction_fit=fraction_fit,
        fraction_evaluate=1.0,   # add this
        min_available_clients=2,   # add this
