...
from flwr_sklearn_xgboost.task import load_data, replace_keys
...
def client_fn(context: Context):
    ...
    return FlowerClient(train_dmatrix, valid_dmatrix, num_train, num_val, num_local_round, cfg["params"],)
