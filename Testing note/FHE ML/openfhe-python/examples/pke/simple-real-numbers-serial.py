...
datafolder = "demoData"
ccLocation = "Save_loca/cryptocontext.txt"
pubKeyLocation = "Save_loca/key_pub.txt"  # Pub key
multKeyLocation = "Save_loca/key_mult.txt"  # relinearization key
rotKeyLocation = "Save_loca/key_rot.txt"  # automorphism / rotation key

# Save-load locations for RAW ciphertexts
cipherOneLocation = "Save_loca/ciphertext1.txt"
cipherTwoLocation = "Save_loca/ciphertext2.txt"

# Save-load locations for evaluated ciphertexts
cipherMultLocation = "Save_loca/ciphertextMult.txt"
cipherAddLocation = "Save_loca/ciphertextAdd.txt"
cipherRotLocation = "Save_loca/ciphertextRot.txt"
cipherRotNegLocation = "Save_loca/ciphertextRotNegLocation.txt"
clientVectorLocation = "Save_loca/clientVectorFromClient.txt"
